...
```json
{
  "command_contract_schema_coverage": {
    ...
    "status": "available",
    "summary": "199 command(s), 158 JSON command(s), 97 mutating command(s), 93 mutating JSON command(s); verified everyday/agent machine surface has 47 concrete schema-backed JSON command(s); advanced/internal/admin surfaces carry 44 accepted opaque schema(s) outside clean verification",
