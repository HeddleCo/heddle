...
Generated by `scripts/program/gen-cli-domain-residual.py` at 2026-07-11T20:48:47Z.
...
| 166 | yes | `crates/cli/src/cli/commands/maintenance.rs` | `cmd_maintenance` |
...
| 119 | yes | `crates/cli/src/cli/commands/goto.rs` | `cmd_switch_state_checkout` |
...
| 84 | yes | `crates/cli/src/cli/commands/index.rs` | `cmd_index` |
| 71 | yes | `crates/cli/src/cli/commands/oss.rs` | `cmd_git_overlay_guide` |
| 55 | yes | `crates/cli/src/cli/commands/monitor.rs` | `cmd_monitor` |

**Total files with cmd_*:** 67
**Total LOC in those files:** 51119
