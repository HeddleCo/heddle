...
**Who:** a headless invocation of heddle from an automated system. Could be Claude operating heddle as a tool, CI, or a hosted adapter using the public Heddle API.
