...
use discovery::{
    RepositoryOpenMode, bounded_ancestor_paths, has_git_repository_at_root,
    metadataless_managed_thread_root,
};
...
use overlay::{
    GitHeadState, detect_git_head_state, detect_git_in_progress_branch, ensure_git_overlay_exclude,
    resolve_git_dir,
};
#[cfg(feature = "git-overlay")]
pub use overlay::{
