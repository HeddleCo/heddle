...
pub use repository::{
    ...
    CommitGraphIndex, CommitGraphInspection, ContextSuggestion, ContextSuggestionTier, DiffKind,
    GitCheckpointRecord, GitOverlayBranchTip, GitOverlayImportHint, GitRemoteTrackingStatus,
