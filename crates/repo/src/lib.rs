...
mod repository_semantic_graph_query;
#[cfg(test)]
mod repository_semantic_graph_query_tests;
...
pub use repository::{
    ...
    PartialFetchInspection, ProvenanceConfig, PullPlannerCacheInspection, RefCountsInspection,
    RepoConfig, RepoRemoteConfig, Repository, RepositoryCapability, RepositoryMaintenanceRunReport,
    ...
    TreeBuildProfile, TreeSchemePolicy, TrustedKey, UntrackedSet, UntrackedSubtree,
    WarmCanonicalStoreStats, WorktreeCompareProfile, WorktreeIndexInspection,
    WorktreeStateLookupProfile, WorktreeStatusDetailed, compute_rewrite_pct, discover_heddle_root,
