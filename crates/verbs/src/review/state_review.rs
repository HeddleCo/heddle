...
mod tests {
    ...
    async fn legacy_prost_replay_is_a_controlled_operation_id_conflict() {
        ...
        assert_eq!(
            error.code(),
            crate::review::LocalReviewCode::FailedPrecondition
        );
        assert!(
            error
                .message()
    ...
    async fn local_interface_rejects_a_forged_signature() {
        ...
        assert_eq!(
            error.code(),
            crate::review::LocalReviewCode::InvalidArgument
        );
    ...
    fn local_payload_surfaces_persisted_risk_signals_without_all_signals_flag() {
        ...
        let health = crate::review::get_repo_signal_health(&repo, 10).expect("health");
        assert!(
            health
                .entries
                .iter()
