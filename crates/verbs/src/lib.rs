...
pub use clone_plan::{
    ...
    ClonePlanFacts, ClonePlanOptions, CloneProtocol, CloneRemoteSource, CloneSecurityPreflight,
    CloneThreadSelectError, MonorepoCloneJsonReport, MonorepoClonePlan, MonorepoClonePlanError,
    ...
    MonorepoPlacedJsonRow, MonorepoPlacedNodeSummary, MonorepoSkippedChild, MonorepoSkippedJsonRow,
    ...
    monorepo_rel_display, normalize_clone_depth, plan_adopt, plan_clone, plan_monorepo_clone,
    plan_monorepo_execution, plan_monorepo_node_steps, resolve_adopt_start_path,
    resolve_clone_destination, select_clone_checkout_thread, select_clone_mode,
...
pub use remote::{
    ...
    looks_like_git_forge_remote, looks_like_git_remote_url, looks_like_known_git_host,
