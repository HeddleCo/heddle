...
//!
//! `LocalOpLogBackend` is the storage contract. This trait is the explicit
//! domain recording surface for callers that intentionally build canonical
//! `OpRecord` variants from model values.
