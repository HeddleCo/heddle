...
use api::heddle::api::v1alpha1::{
    ConfidenceBand as ProtoConfidenceBand, GetThreadRequest, GitCheckpointTransfer,
...
mod transfer_id_tests {
    ...
    fn stream_opening_proof_admits_a_short_stable_id_for_a_realistic_transfer() {
        ...
        let push_route = "/heddle.api.v2alpha1.SyncService/PublishContent";
        let pull_route = "/heddle.api.v2alpha1.SyncService/Fetch";
