...
/// Wrapping LocalObjectStore that counts calls to `get_blob`. Used to
...
impl LocalObjectStore for CountingStore {
...
mod capture_write_ops {
    ...
    fn dump_tree(store: &impl LocalObjectStore, hash: &ContentHash) -> Tree {
