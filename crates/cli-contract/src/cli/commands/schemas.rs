...
use super::{
    ...
    wire::{
        ...
        ImportGitOutput, ImportSourceOutput, IntegrationStatusOutput, LandOutput, LogOutput,
        MarkerBulkDeleteOutput, MarkerListOutput, MarkerOpOutput, MultiLandOutput,
        OperatorCommandOutput, PullOutput, PushOutput, ReadyOutput, ReflogOutput,
...
schema_registry! {
    ...
    (&["remote import-source"], ImportSourceOutput),
    (&["pull"], PullOutput),
    (&["push"], PushOutput),
