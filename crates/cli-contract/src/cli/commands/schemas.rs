...
use super::{
    ...
    wire::{
        ...
        ImportGitOutput, ImportOperationOutput, ImportRetryOutput, IntegrationStatusOutput,
        LandOutput, LogOutput, MarkerBulkDeleteOutput, MarkerListOutput, MarkerOpOutput,
        MultiLandOutput, OperatorCommandOutput, PullOutput, PushOutput, ReadyOutput, ReflogOutput,
        RemoteMutationOutput, RepackOutput, RevertOutput, ReviewHealthOutput, ReviewNextOutput,
        ReviewSignOutput, ShowOutput, SnapshotOutput, SyncGitOutput, SyncOutput,
        ThreadCaptureOutput, ThreadCurrentOutput, ThreadListOutput, ThreadOwnershipOutput,
        ...
        thread::{
            ApprovalOutput, ApprovalRevokeOutput, EligibilityOutput, ReviewComparisonOutput,
            ThreadAbsorbOutput, ThreadCleanupOutput, ThreadOpOutput, ThreadRecordOutput,
            ThreadResolveOutput,
        },
    },
};
...
schema_registry! {
    ...
    (&["import local"], AdoptOutput),
    (&["import url", "import status"], ImportOperationOutput),
    (&["import retry"], ImportRetryOutput),
    ...
    (&["thread checkout"], ThreadRecordOutput),
    (&["thread move"], ThreadMoveOutput),
    (&["thread absorb"], ThreadAbsorbOutput),
    (&["thread resolve"], ThreadResolveOutput),
    (&["review approve"], ApprovalOutput),
    (&["review list"], Vec<ApprovalOutput>),
    (&["review revoke"], ApprovalRevokeOutput),
    (&["review readiness"], EligibilityOutput),
    ...
    (&["thread ownership status", "thread ownership claim", "thread ownership resolve"], ThreadOwnershipOutput),
    (&["clone"], CloneOutput),
    ...
    (&["review show"], ReviewComparisonOutput),
    (&["review sign"], ReviewSignOutput),
    (&["review next"], ReviewNextOutput),
    (&["review health"], ReviewHealthOutput),
    (&["discuss new", "discuss reply", "discuss resolve", "discuss reopen"], DiscussionWriteOutput),
    ...
    (&["auth invite", "invite"], SignupInviteCreatedOutput),
    (&["auth invite list", "invite list"], SignupInviteListOutput),
